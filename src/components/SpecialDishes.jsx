...
const DishCard = ({ dish, onToggleLike }) => {
    ...
    return (
        <div className="bg-white rounded-3xl max-w-[316px] h-[410px] shadow-lg p-5 flex flex-col relative">
            ...
            <img src={dish.image} alt={dish.name} className="rounded-full w-40 md:w-52 h-40 md:h-52 object-cover mb-4 mx-auto" />
    ...
    return (
        <section className="py-10 ">
            <div className="container mx-auto w-11/12 md:w-4/5">
                <h2 className="text-red-500 font-bold uppercase text-base md:text-lg mb-4">Special Dishes</h2>
                <div className='flex flex-col md:flex-row justify-between'>
                    <h3 className="text-2xl md:text-4xl font-bold mt-4 md:mt-6 mb-6 md:mb-8">Standout Dishes <br />From Our Menu</h3>

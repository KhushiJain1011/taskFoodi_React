...
const DishCard = ({ dish, onToggleLike }) => {
    ...
    return (
        <div className="bg-white rounded-3xl w-[316px] h-[410px] shadow-lg p-5 flex flex-col relative">
            <button onClick={toggleLike} className="absolute top-3 right-3 w-12 h-12 bg-green-500 rounded-bl-3xl flex items-center justify-center">
                <img src={liked ? heartFilled : heartOutline} alt="like" className="w-4 h-4" />
            </button>
            <img src={dish.image} alt={dish.name} className="rounded-full w-52 h-52 object-cover mb-4 mx-auto" />
            ...
            <div className="flex items-center justify-between w-full mt-4 mx-5">
                <span className="text-red-500 font-bold text-xl">${dish.price.toFixed(2)}</span>
    ...
    return (
        <section className="py-10 ">
            <div className="container mx-auto w-4/5">
                <h2 className="text-red-500 font-bold uppercase text-lg mb-4">Special Dishes</h2>
                <div className='flex justify-between'>
                    <h3 className="text-4xl font-bold mt-6 mb-8">Standout Dishes <br />From Our Menu</h3>
                    <div className='flex mx-4 mt-6 mb-8'>
                        <button className="w-12 h-12 mx-4 rounded-full bg-gray-300 hover:bg-gray-400 flex items-center justify-center">
                            <img src={leftarrow} alt="" />
                        </button>
                        <button className="w-12 h-12 mx-4 rounded-full bg-green-500 hover:bg-green-600 text-white flex items-center justify-center">

...
const HeroSection = () => {
    return (
        <section className="flex flex-col md:flex-row items-center justify-between px-8 py-16 bg-white">
            <div className="md:w-1/2 text-center md:text-left space-y-6 ml-24">
                ...
                <div className="space-x-4 flex">
                    ...
                    <button className="bg-white  text-gray-700 px-6 py-3 rounded-full font-medium text-lg hover:bg-green-100">
                        Watch Video
                    </button>
            ...
            <div className="relative mt-8 md:mt-0 md:w-1/2 flex justify-center">
                <img
                    src={girlHomePage}
                    alt="Person eating"
                    className="w-[300px] h-[300px] md:w-[350px] md:h-[350px] rounded-full shadow-lg object-cover bg-green-500"
                />
                ...
                <div className="absolute -bottom-12 left-4 flex space-x-4">
                    <div className="flex items-center bg-white shadow-lg rounded-xl p-2 space-x-2 w-[300px] h-[110px]">
                        <img
                            src={spicyNoodles}
                            alt="Spicy Noodles"
                        ...
                        <div>
                            ...
                            <p className="text-lg
                            font-semibold text-gray-500"><span className='text-red-600'>$</span>18.00</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center bg-white shadow-lg rounded-xl p-2 space-x-2 w-[300px] h-[110px]">
                        ...
                        <div>
                            <p className="text-lg
                            font-semibold text-gray-700">Vegetarian Salad</p>
                            <img src={threeStar} alt="" />
                            <p className="text-lg
